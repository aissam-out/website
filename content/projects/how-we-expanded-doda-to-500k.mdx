...
[DODa](https://github.com/darija-open-dataset/dataset) has addressed that problem in stages. The first release organized Darija vocabulary, semantic and syntactic categories, morphology, conjugation and spelling variants. The next expansion added tens of thousands of translated sentences in both Arabic and Latin scripts.

The latest expansion asks a larger question: can [DODa](https://github.com/darija-open-dataset/dataset) become a corpus large and varied enough for modern models?
