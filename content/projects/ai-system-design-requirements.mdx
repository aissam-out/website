...
*Figure 1. The platform coordinates several authorities. Trust, ownership, and availability do not automatically transfer across an integration.*
...
*Figure 2. Behavioral configuration is pinned to a run. Current access policy can still narrow what that run may do.*
...
*Figure 3. Accepting a run establishes durable work. Evidence gathering and proposal generation happen before any approved external write.*
